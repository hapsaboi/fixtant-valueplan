...
import nrc from '../../images/nrc logo.png';
...
export default ({textOnLeft = false}) => {
  ...
  return (
    <Container>
      <TwoColumn>
        <ImageColumn>
          <Image imageSrc={nrc} style={{width:"100%", height:"100%"}} />
        </ImageColumn>
        <TextColumn textOnLeft={textOnLeft}>
          <TextContent>
            <Heading>Currently operating in 4 states.</Heading>
            <Description>This system allows users to book trains from the Abuja - Kaduna Channel and the Lagos - Ibadan Channel.</Description>
            <Statistics>
