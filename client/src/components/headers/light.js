    ...
    <NavLinks key={1}>
      ...
      {Object.keys(userDetail).length>0?
          <>
            ...
            <NavLink as={Link} to="/client/profile"> Profile</NavLink>
            <NavLink css={roundedHeaderButton && tw`rounded-full`} onClick={()=>logout()} > Logout</NavLink>
          </>
        :
          <PrimaryLink css={roundedHeaderButton && tw`rounded-full`} as={Link} to="/login"> Login</PrimaryLink>
      } 
    </NavLinks>
  ];
