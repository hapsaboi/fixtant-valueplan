...
function Login() {
  ...
  let data = {
    ...
    headingText : "Sign In Fixtant - Value Plan",
          ...
          <MainContent>
            ...
            <FormContainer>
              ...
              <p tw="mt-6 text-xs text-gray-600 text-center">
                <a href={data.forgotPasswordUrl} tw="border-b border-gray-500 border-dotted">
                  Forgot Password ?
                </a>
              </p>
              <p tw="mt-8 text-sm text-gray-600 text-center">
                Dont have an account?{" "}
                <Link to={data.signupUrl} tw="border-b border-gray-500 border-dotted">
                  Sign Up
                </Link>
              </p>
            </FormContainer>
